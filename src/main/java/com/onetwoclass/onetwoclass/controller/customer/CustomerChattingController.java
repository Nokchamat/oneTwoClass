...
@RestController
@RequestMapping("/api/v1/customer/chatting")
@RequiredArgsConstructor
public class CustomerChattingController {
  ...
  ResponseEntity<?> getChattingByChattingRoomId(@PathVariable Long chattingRoomId,
      @AuthenticationPrincipal Member customer, Pageable pageable) {

    return ResponseEntity.ok(
        chattingService.getCustomerChattingByChattingRoomId(chattingRoomId, customer, pageable));
  }
