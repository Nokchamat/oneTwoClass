...
//
//    System.out.println(dayClass.getId());
//
//    DayClass updatedDayClass = dayClassRepository.findById(dayClass.getId())
//        .orElseThrow(() -> new CustomException(ErrorCode.NOT_FOUND_DAYCLASS));
//
//    //then
//    assertEquals(updatedDayClass.getDayClassName(), updateDayClassForm.getToChangeDayClassName());
...
//            "success_getAllDayClassByDayClassName", Pageable.ofSize(5));
//
//    //then
//    assertEquals(dayClassDtoList.getTotalElements(), 2);
