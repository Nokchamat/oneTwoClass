...
class DayClassBookmarkServiceTest {
  ...
  void success_addDayClassBookmark() {
    ...
    AddDayClassBookmarkForm addDayClassBookmarkForm =
        AddDayClassBookmarkForm.builder().dayClassId(dayClassDocument.getId()).build();
  ...
  void success_deleteDayClassBookmark() {
    ...
    DayClassDocument dayClassDocument1 = dayClassSearchRepository.save(
        DayClassDocument.builder()
            .dayClassName("빵 클래스")
            .explains("여러 마카롱을 맛볼 수 있고 만들어요 !")
            .price(5000)
    ...
    DayClassDocument dayClassDocument2 = dayClassSearchRepository.save(
        DayClassDocument.builder()
            .dayClassName("빵 클래스")
            .explains("여러 마카롱을 맛볼 수 있고 만들어요 !")
            .price(5000)
    ...
    DayClassBookmark dayClassBookmark = dayClassBookmarkRepository.save(DayClassBookmark.builder()
        .customer(customer)
        .dayClassId(dayClassDocument1.getId())
        .build());

    dayClassBookmarkRepository.save(DayClassBookmark.builder()
        .customer(customer)
        .dayClassId(dayClassDocument2.getId())
        .build());
